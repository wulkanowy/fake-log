...
router.all('/SprawdzianSzczegoly', (_req, res) => {
  ...
  res.json({
    ...
    nauczycielImieNazwisko: `${getByValue(teachers, 'id', exam.creatorId).firstName} ${
      getByValue(teachers, 'id', exam.creatorId).lastName
    }`,
...
router.all('/ZadanieDomoweSzczegoly', (_req, res) => {
  ...
  res.json({
    ...
    nauczycielImieNazwisko: `${getByValue(teachers, 'id', item.creatorId).firstName} ${
      getByValue(teachers, 'id', item.creatorId).lastName
    }`,
  ...
  res.json({
    ocenyPrzedmioty: grades.subjects.map((gradesSubject) => ({
      ...
      ocenyCzastkowe: gradesSubject.partialGrades.map((grade) => ({
        ...
        nauczyciel: `${getByValue(teachers, 'id', grade.modifierId).firstName} ${
          getByValue(teachers, 'id', grade.modifierId).lastName
        } [${getByValue(teachers, 'id', grade.modifierId).code}]`,
